/**
 * Created by richpolis on 30/04/17.
 */
angular.module('laReta.paypalServices', [])
    .constant('shopSettings',{
        payPalSandboxId :'AcRLsWj50AZ8PRqzXx0k5rxMK1yM2TseLy2RvjtaD9IB2_q--wWt8OtNXRtHJz2X5JgUQCCmcGVIj19D',
        payPalProductionId : 'AcRLsWj50AZ8PRqzXx0k5rxMK1yM2TseLy2RvjtaD9IB2_q--wWt8OtNXRtHJz2X5JgUQCCmcGVIj19D',
        payPalEnv: 'PayPalEnvironmentSandbox', // for testing production for production
        payPalShopName : 'LaReta',
    ...
    .factory('PaypalService', ['$q', '$ionicPlatform', 'shopSettings', '$filter', '$timeout', 
        ...
        function createPayment(total, name) {
            ...
            //return payment;
            var payment = new PayPalPayment("" + total, "MXN", "" + name, "Sale");
            return payment;
        }
        /**
         * @ngdoc method
